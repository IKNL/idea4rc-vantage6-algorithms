...
COHORT_R_DATE_COLUMNS = [
    ...
    "targeted_4_start_date",
    "targeted_5_start_date",
    "targeted_6_start_date",
    "targeted_7_start_date",
    ...
    "progression_or_recurrence_4_date",
    "progression_or_recurrence_5_date",
    "progression_or_recurrence_6_date",
    "progression_or_recurrence_7_date",
