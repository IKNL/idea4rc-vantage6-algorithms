WITH
    ...
    tumor_grade AS (
        ...
        FROM (
            ...
            FROM
                patient_list pl
            LEFT JOIN
                cdm2.measurement measurement
                ON pl.person_id = measurement.person_id
            left join
                cdm2.concept grade_concept
    ...
    primary_tumor AS (
        ...
        FROM
            patient_list pl
        LEFT JOIN
            cdm2.episode episode
            ON pl.person_id = episode.person_id
        LEFT JOIN
        	cdm2.concept diagnosis_concept
   ...
   UNION
        ...
        FROM
            patient_list pl
        LEFT JOIN
            cdm2.condition_occurrence condition
    ...
    resection AS (
        ...
        left join
            ...
            on surgery.person_id = measurement.person_id
        LEFT JOIN
            cdm2.concept resection_concept
