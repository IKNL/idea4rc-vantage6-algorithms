...
`overall_treatment_response_response`|`CategoricalDtype`|🆕|`concept_name` of `episode.episode_concept_id` where `episode_concept_id` is one of `32946`, `32947`, `32948`, `32949` and `episode_start_date` is between last treatment end date (any of the defined treatment, e.g. radio, chemo, surgery) (included, ≥) and the first recurrence (see [Treatment settings](#treatment-settings-) for the definition of the recurrence) (excluded, <)
...
Overall treatment response date|`datetime64[ns, tz]`|🆕|`episode_start_date` of `episode.episode_concept_id` where `episode_concept_id` is one of `32946`, `32947`, `32948`, `32949` and `episode_start_date` is between last treatment end date (any of the defined treatment, e.g. radio, chemo, surgery) (included, ≥) and the first recurrence (see [Treatment settings](#treatment-settings-) for the definition of the recurrence) (excluded, <)
